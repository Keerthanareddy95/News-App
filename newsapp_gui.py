...
class NewsApp:
    ...
    def __init__(self):
        # Fetching data
        self.data = requests.get('https://newsapi.org/v2/top-headlines?country=in&apiKey=b1972518a6a44355b1e8dcae4e544d4f').json()
        print(self.data)
    ...
    def load_gui(self):
        ...
        self.root.title("Honey's News App")
        self.root.configure(background='black')

    def clear(self):
        # Destroy widgets before clearing
